...
import static com.algamil.souqelwasta.data.local.SharedPreferencesManger.setSharedPreferences;
...
public class TinyDB {
    ...
    public void putNewObject( String KEY , Elements myObject )
    {
        myObject = new Elements();
    ...
    public Elements getNewObject(String KEY)
    {
        Gson gson = new Gson();
        String json = preferences.getString(KEY, null);
        Elements obj = gson.fromJson(json, Elements.class);
        return obj;
    }

    public <T> void putObject(String key, Object obj){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    ...
    public List<Elements> getList(String KEY_PREFS){
        List<Elements> arrayItems = null;
        String serializedObject = preferences.getString(KEY_PREFS, null);
