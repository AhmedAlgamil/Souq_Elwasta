...
public class MarketItemAdapters extends RecyclerView.Adapter<MarketItemAdapters.CustomRecyclerViewHolder> {
    ...
    public MarketItemAdapters(FragmentActivity activity, Elements elements) {
            ...
            itemPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (elements.get(position).parent().parent().className().equals("post-media")) {
                        ...
                        HelperMethod.replaceFragment(activity.getSupportFragmentManager(), R.id.frame_section, new ProductHomeFragment());
                    }
                }
            });
