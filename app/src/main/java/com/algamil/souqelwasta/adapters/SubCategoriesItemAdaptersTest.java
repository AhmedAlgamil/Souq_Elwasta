...
import com.algamil.souqelwasta.views.fragments.MarketHomeFragment;
...
public class SubCategoriesItemAdaptersTest extends Adapter<SubCategoriesItemAdaptersTest.CustomRecyclerViewHolder> {
    ...
    public SubCategoriesItemAdaptersTest(FragmentActivity activity, Elements els) {
        ...
        try {
            ...
            itemCategory.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    tinyDB.putString(HREF , elements.select("a[href]").get(position).attr("href"));
                    tinyDB.putString( SUB_CATS , "from sub cat");
                    HelperMethod.replaceFragment(activity.getSupportFragmentManager() , R.id.frame_section , new MarketHomeFragment());
                }
            });
        }
        catch (Exception e)
